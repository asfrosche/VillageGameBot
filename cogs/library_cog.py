...
LIBRARIAN_IDS = [321117543378976771, 365954082281881600, 887214529170268190, 1082939271914201199, 1234829080898310197, 320504417520582664, 197169839863758848, 450772749829537793, 570023325653270548, 691180618402234399, 538814265599983617, 319848617814917120, 556911428712398869, 9556911428712398869, 629760692660207626, 514728129395294210]
...
class TeamSelectView(discord.ui.View):
    ...
    def get_embed(self) -> discord.Embed:
        ...
        if roles_basic:
            ...
            roles_text = ""
            for role_id, role_name, player_name, count_flag in page_roles:
            ...
            field_name = (
                f"Roles ({start_idx + 1}-{end_idx} of {len(roles_basic)})"
